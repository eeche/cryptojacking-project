...
do
    ...
    sudo trace-cmd report > $SAVE_DIR/blog_$n.txt
    echo "시스템 콜 데이터는 $SAVE_DIR/blog_$n.txt 에 저장되었습니다."
...
do
    ...
    sudo trace-cmd report > $SAVE_DIR/blog_bytecoin_$n.txt
    echo "시스템 콜 데이터는 $SAVE_DIR/blog_bytecoin_$n.txt 에 저장되었습니다."
...
do
    ...
    sudo trace-cmd report > $SAVE_DIR/blog_dashcoin_$n.txt
    echo "시스템 콜 데이터는 $SAVE_DIR/blog_dashcoin_$n.txt 에 저장되었습니다."
    sleep 10
done
...
do
    ...
    sudo trace-cmd report > $SAVE_DIR/blog_monero_$n.txt
    echo "시스템 콜 데이터는 $SAVE_DIR/blog_monero_$n.txt 에 저장되었습니다."
    sleep 10
done
...
do
    ...
    sudo trace-cmd report > $SAVE_DIR/blog_nimiq_$n.txt
    echo "시스템 콜 데이터는 $SAVE_DIR/blog_nimiq_$n.txt 에 저장되었습니다."
    sleep 10
done
