...
target_syscalls = [
    ...
    "sys_enter_times", "sys_enter_inotify_add_watch", "sys_enter_gettid", "sys_enter_timerfd_settime",
    "sys_enter_readlink", "sys_enter_socket", "sys_enter_sched_yield", "sys_enter_access", "sys_enter_munmap",
